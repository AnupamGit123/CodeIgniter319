...
<body>
	...
	<h5 class="orange white-text section center-align hide-on-med-and-up">Men Fashion Category</h5>
	<!-- electronics title section end -->
	<ul class="collapsible hide-on-med-and-up">
		<li>
			<div class="collapsible-header">Foot Wear&nbsp;&nbsp; <span class="fa fa-angle-down" style="margin-top: 4px;"></span></div>
		...
		<li>
			<div class="collapsible-header">Top Wear&nbsp;&nbsp; <span class="fa fa-angle-down" style="margin-top: 4px;"></span></div>
			<div class="collapsible-body">
				<ul id="set_links">
		...
		<li>
			<div class="collapsible-header">Bottom Wear&nbsp;&nbsp; <span class="fa fa-angle-down" style="margin-top: 4px;"></span></div>
			<div class="collapsible-body">
				<ul id="set_links">
					<li><a href="">Samsung</a></li>
					<li><a href="">Sony</a></li>
